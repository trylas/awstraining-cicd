...
```
docker tag prometheus-custom <<987511300777>>.dkr.ecr.eu-central-1.amazonaws.com/monitoring:prometheus
```

```
docker push <<987511300777>>.dkr.ecr.eu-central-1.amazonaws.com/monitoring:prometheus
```
