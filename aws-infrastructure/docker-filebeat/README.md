...
```
docker tag filebeat-custom 987511300777.dkr.ecr.eu-central-1.amazonaws.com/monitoring:filebeat
```

```
docker push 987511300777.dkr.ecr.eu-central-1.amazonaws.com/monitoring:filebeat
```
